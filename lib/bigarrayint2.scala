...
// Note: the rest is semi-automatically generated from a well-tested code at
...
// then adding annots on ": Array[Int]" and "Array[Int] =>" and vars via regex
  ...
  def toIntFromBig(n@: Array[Int]): Int = {
    withSgn[Int](n, {def _1@(big_sgn: Int) = {
      var ret@ = 0;
      var i@ = 0;
      while (i < n.length) {
  ...
  def withAddBig[U](lhs@: Array[Int], rhs@: Array[Int], f@: Array@[Int] => U): U = {
    withSgn[U](lhs, {def _1@(lhsSgn: Int) = {
      withSgn[U](rhs, {def _2@(rhsSgn: Int) = {
        if (rhsSgn == 0) f(lhs)
        else if (lhsSgn == 0) f(rhs)
        else if (lhsSgn == rhsSgn) {
          big_withAddMag[U](lhs, rhs, {def _3@(sum@: Array[Int]) = {
            big_sgnSet(sum, lhsSgn);
            f(sum)
          };_3})
        }
        else {
          big_withMagDiff[U](lhs, rhs, {def _4@(sum@: Array[Int]) = {
    ...
    if (big_sgn(rhs) == 0) f(lhs)
      ...
      withSgn[U](lhs, {def _1@(lhsSgn: Int) = {
        withSgn[U](rhs, {def _2@(rhsSgn: Int) = {
          ...
          if (lhsSgn != rhsSgn) big_withAddMag[U](lhs, rhs, {def _3@(big_retMag@: Array[Int]) = {
            k(big_retMag, lhsSgn)
          };_3})
          else big_withMagDiff[U](lhs, rhs, {def _3@(big_retMag@: Array[Int]) = {
  ...
  def withMulBig[U](lhs@: Array[Int], rhs@: Array[Int], f@: Array@[Int] => U): U = {
    withSgn[U](lhs, {def _1@(lhsSgn: Int) = {
      withSgn[U](rhs, {def _2@(rhsSgn: Int) = {
        big_withMulMag[U](lhs, rhs, {def _3@(t@: Array[Int]) = {
          big_withNoLeadingZeroes[U](t, {def _4@(product@: Array[Int]) = {
  ...
  def cmpBig(lhs@: Array[Int], rhs@: Array[Int]): Int = {
    withSgn[Int](lhs, {def _1@(lhsSgn: Int) = {
      withSgn[Int](rhs, {def _2@(rhsSgn0: Int) = {
  ...
  def big_withMulMag[U](lhs@: Array[Int], rhs@: Array[Int], f@: Array@[Int] => U): U = {
    ...
    val lhsIdx = lhs.length - 1;
    val rhsIdx = rhs.length - 1;
    ret(ret.length - 1) = 0;
    var i@ = lhsIdx;
    while (i >= 0) {
      var carry@ = 0;
  ...
  def big_withDivMag[U](lhs@: Array[Int], rhs@: Array[Int], f@: Array@[Int] => U): U = {
    ...
    def binarySearch@(lo@: Array[Int], hi@: Array[Int]): U = {
      if (cmpBig(lo, hi) < 0) {
        big_withAddMag[U](hi, one, {def _1@(hiPlus1@: Array[Int]) = {
          big_withAddMag[U](lo, hiPlus1, {def _2@(twiceMid@: Array[Int]) = {
            big_withDiv2Mag[U](twiceMid, {def _3@(mid@: Array[Int]) = {
              withMulBig[U](mid, rhs, {def _4@(product@: Array[Int]) = {
                if (cmpBig(product, lhs) <= 0)
                  binarySearch(mid, hi)
                else big_withSubMag[U](mid, one, {def _5@(hiNext@: Array[Int]) = {
    ...
    big_withPowBase[U](loLog, {def _1@(lo@: Array[Int]) = {
      big_withPowBase[U](hiLog, {def _2@(hi@: Array[Int]) = {
        binarySearch(lo, hi)
      };_2})
    };_1})
  };
